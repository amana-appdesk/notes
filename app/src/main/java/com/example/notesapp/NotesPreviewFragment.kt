...
class NotesPreviewFragment : Fragment(), OnItemClick {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.addNoteBtn.setOnClickListener {
            val action =
                NotesPreviewFragmentDirections.actionNotesPreviewFragmentToNotesFragment(true, null)
    ...
    override fun notesClick(position: Int) {
        ...
        val action =
            NotesPreviewFragmentDirections.actionNotesPreviewFragmentToNotesFragment(false, str)
        Navigation.findNavController(requireView()).navigate(action)
    }
